  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                ...
                child: Column(
                  children: [
                    const Row(
                      ...
                      children: [
                        Text("Courses", style: TextStyle(fontFamily: 'RobotoMono', color: Colors.black, fontWeight: FontWeight.bold, fontSize: 18)),
                      ],
                    ),
                        ...
                        return InkWell(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(
                              builder: (context) => CourseDetailsPage(courselist[index].coursename, courselist[index].duration),
                              ));
                          },
                          child: Container(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(icon: Icon(Icons.card_giftcard_sharp), label: 'My Rewards'),
          BottomNavigationBarItem(icon: Icon(Icons.business_outlined), label: 'Marketplace'),
          BottomNavigationBarItem(icon: Icon(Icons.home), label: 'Home'),
          BottomNavigationBarItem(icon: Icon(Icons.school_outlined), label: 'My Courses'),
          BottomNavigationBarItem(icon: Icon(Icons.question_answer_outlined), label: 'FAQs'),
        ],
